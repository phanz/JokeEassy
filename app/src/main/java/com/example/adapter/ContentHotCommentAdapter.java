...
public class ContentHotCommentAdapter extends BaseAdapter {
    ...
    public ContentHotCommentAdapter(Context context){
        mContext = context;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            view = mInflater.inflate(R.layout.item_content_hot_comment,viewGroup,false);
